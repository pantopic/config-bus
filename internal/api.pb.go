...
func (x *LeaseCheckBatchRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LeaseCheckBatchRequest) ProtoMessage() {}

func (x *LeaseCheckBatchRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[40]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LeaseCheckBatchRequest.ProtoReflect.Descriptor instead.
func (*LeaseCheckBatchRequest) Descriptor() ([]byte, []int) {
...
func (x *LeaseCheckBatchResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LeaseCheckBatchResponse) ProtoMessage() {}

func (x *LeaseCheckBatchResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[41]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LeaseCheckBatchResponse.ProtoReflect.Descriptor instead.
func (*LeaseCheckBatchResponse) Descriptor() ([]byte, []int) {
...
const file_api_proto_rawDesc = "" +
	...
	"grantedTTL\x12\x12\n" +
	"\x04keys\x18\x05 \x03(\fR\x04keys\"*\n" +
	"\x16LeaseCheckBatchRequest\x12\x10\n" +
	"\x03IDs\x18\x01 \x03(\x03R\x03IDs\"-\n" +
	"\x17LeaseCheckBatchResponse\x12\x12\n" +
	"\x04TTLs\x18\x01 \x03(\x03R\x04TTLs\"\x1d\n" +
...
var file_api_proto_goTypes = []any{
	...
	(*LeaseCheckBatchRequest)(nil),        // 49: etcdserverpb.LeaseCheckBatchRequest
	(*LeaseCheckBatchResponse)(nil),       // 50: etcdserverpb.LeaseCheckBatchResponse
	(*LeaseStatus)(nil),                   // 51: etcdserverpb.LeaseStatus
	(*LeaseLeasesRequest)(nil),            // 52: etcdserverpb.LeaseLeasesRequest
	(*LeaseLeasesResponse)(nil),           // 53: etcdserverpb.LeaseLeasesResponse
	(*Member)(nil),                        // 54: etcdserverpb.Member
	(*MemberAddRequest)(nil),              // 55: etcdserverpb.MemberAddRequest
	(*MemberAddResponse)(nil),             // 56: etcdserverpb.MemberAddResponse
	(*MemberRemoveRequest)(nil),           // 57: etcdserverpb.MemberRemoveRequest
	(*MemberRemoveResponse)(nil),          // 58: etcdserverpb.MemberRemoveResponse
	(*MemberUpdateRequest)(nil),           // 59: etcdserverpb.MemberUpdateRequest
	(*MemberUpdateResponse)(nil),          // 60: etcdserverpb.MemberUpdateResponse
	(*MemberListRequest)(nil),             // 61: etcdserverpb.MemberListRequest
	(*MemberListResponse)(nil),            // 62: etcdserverpb.MemberListResponse
	(*MemberPromoteRequest)(nil),          // 63: etcdserverpb.MemberPromoteRequest
	(*MemberPromoteResponse)(nil),         // 64: etcdserverpb.MemberPromoteResponse
	(*DefragmentRequest)(nil),             // 65: etcdserverpb.DefragmentRequest
	(*DefragmentResponse)(nil),            // 66: etcdserverpb.DefragmentResponse
	(*MoveLeaderRequest)(nil),             // 67: etcdserverpb.MoveLeaderRequest
	(*MoveLeaderResponse)(nil),            // 68: etcdserverpb.MoveLeaderResponse
	(*AlarmMember)(nil),                   // 69: etcdserverpb.AlarmMember
	(*AlarmRequest)(nil),                  // 70: etcdserverpb.AlarmRequest
	(*AlarmResponse)(nil),                 // 71: etcdserverpb.AlarmResponse
	(*DowngradeRequest)(nil),              // 72: etcdserverpb.DowngradeRequest
	(*DowngradeResponse)(nil),             // 73: etcdserverpb.DowngradeResponse
	(*StatusRequest)(nil),                 // 74: etcdserverpb.StatusRequest
	(*StatusResponse)(nil),                // 75: etcdserverpb.StatusResponse
}
var file_api_proto_depIdxs = []int32{
	...
	51, // 44: etcdserverpb.LeaseLeasesResponse.leases:type_name -> etcdserverpb.LeaseStatus
	11, // 45: etcdserverpb.MemberAddResponse.header:type_name -> etcdserverpb.ResponseHeader
	54, // 46: etcdserverpb.MemberAddResponse.member:type_name -> etcdserverpb.Member
	54, // 47: etcdserverpb.MemberAddResponse.members:type_name -> etcdserverpb.Member
	11, // 48: etcdserverpb.MemberRemoveResponse.header:type_name -> etcdserverpb.ResponseHeader
	54, // 49: etcdserverpb.MemberRemoveResponse.members:type_name -> etcdserverpb.Member
	11, // 50: etcdserverpb.MemberUpdateResponse.header:type_name -> etcdserverpb.ResponseHeader
	54, // 51: etcdserverpb.MemberUpdateResponse.members:type_name -> etcdserverpb.Member
	11, // 52: etcdserverpb.MemberListResponse.header:type_name -> etcdserverpb.ResponseHeader
	54, // 53: etcdserverpb.MemberListResponse.members:type_name -> etcdserverpb.Member
	11, // 54: etcdserverpb.MemberPromoteResponse.header:type_name -> etcdserverpb.ResponseHeader
	54, // 55: etcdserverpb.MemberPromoteResponse.members:type_name -> etcdserverpb.Member
	...
	69, // 62: etcdserverpb.AlarmResponse.alarms:type_name -> etcdserverpb.AlarmMember
	...
	52, // 76: etcdserverpb.Lease.LeaseLeases:input_type -> etcdserverpb.LeaseLeasesRequest
	55, // 77: etcdserverpb.Cluster.MemberAdd:input_type -> etcdserverpb.MemberAddRequest
	57, // 78: etcdserverpb.Cluster.MemberRemove:input_type -> etcdserverpb.MemberRemoveRequest
	59, // 79: etcdserverpb.Cluster.MemberUpdate:input_type -> etcdserverpb.MemberUpdateRequest
	61, // 80: etcdserverpb.Cluster.MemberList:input_type -> etcdserverpb.MemberListRequest
	63, // 81: etcdserverpb.Cluster.MemberPromote:input_type -> etcdserverpb.MemberPromoteRequest
	70, // 82: etcdserverpb.Maintenance.Alarm:input_type -> etcdserverpb.AlarmRequest
	74, // 83: etcdserverpb.Maintenance.Status:input_type -> etcdserverpb.StatusRequest
	65, // 84: etcdserverpb.Maintenance.Defragment:input_type -> etcdserverpb.DefragmentRequest
	...
	67, // 88: etcdserverpb.Maintenance.MoveLeader:input_type -> etcdserverpb.MoveLeaderRequest
	72, // 89: etcdserverpb.Maintenance.Downgrade:input_type -> etcdserverpb.DowngradeRequest
	...
	53, // 100: etcdserverpb.Lease.LeaseLeases:output_type -> etcdserverpb.LeaseLeasesResponse
	56, // 101: etcdserverpb.Cluster.MemberAdd:output_type -> etcdserverpb.MemberAddResponse
	58, // 102: etcdserverpb.Cluster.MemberRemove:output_type -> etcdserverpb.MemberRemoveResponse
	60, // 103: etcdserverpb.Cluster.MemberUpdate:output_type -> etcdserverpb.MemberUpdateResponse
	62, // 104: etcdserverpb.Cluster.MemberList:output_type -> etcdserverpb.MemberListResponse
	64, // 105: etcdserverpb.Cluster.MemberPromote:output_type -> etcdserverpb.MemberPromoteResponse
	71, // 106: etcdserverpb.Maintenance.Alarm:output_type -> etcdserverpb.AlarmResponse
	75, // 107: etcdserverpb.Maintenance.Status:output_type -> etcdserverpb.StatusResponse
	66, // 108: etcdserverpb.Maintenance.Defragment:output_type -> etcdserverpb.DefragmentResponse
	...
	68, // 112: etcdserverpb.Maintenance.MoveLeader:output_type -> etcdserverpb.MoveLeaderResponse
	73, // 113: etcdserverpb.Maintenance.Downgrade:output_type -> etcdserverpb.DowngradeResponse
