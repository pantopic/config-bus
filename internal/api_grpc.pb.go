...
type MaintenanceClient interface {
	...
	HashKV(ctx context.Context, in *HashPCBequest, opts ...grpc.CallOption) (*HashPCBesponse, error)
...
func (c *maintenanceClient) HashKV(ctx context.Context, in *HashPCBequest, opts ...grpc.CallOption) (*HashPCBesponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HashPCBesponse)
...
type MaintenanceServer interface {
	...
	HashKV(context.Context, *HashPCBequest) (*HashPCBesponse, error)
...
func (UnimplementedMaintenanceServer) HashKV(context.Context, *HashPCBequest) (*HashPCBesponse, error) {
...
func _Maintenance_HashKV_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MaintenanceServer).HashKV(ctx, req.(*HashPCBequest))
	}
	return interceptor(ctx, in, info, handler)
}
