...
var flagName = map[*bool]string{
	&PCB_RANGE_COUNT_FULL:           "RANGE_COUNT_FULL",
	&PCB_RANGE_COUNT_FAKE:           "RANGE_COUNT_FAKE",
	&PCB_RANGE_COUNT_FILTER_CORRECT: "RANGE_COUNT_FILTER_CORRECT",
	&PCB_PATCH_ENABLED:              "PATCH_ENABLED",
	&PCB_COMPRESSION_ENABLED:        "COMPRESSION_ENABLED",
	&PCB_TXN_MULTI_WRITE_ENABLED:    "TXN_MULTI_WRITE_ENABLED",
	&PCB_WATCH_ID_ZERO_INDEX:        "WATCH_ID_ZERO_INDEX",
	&PCB_READ_LOCAL:                 "READ_LOCAL",
	&PCB_BATCH_LEASE_RENEWAL:        "BATCH_LEASE_RENEWAL",
}

var flagNameInt = map[*int]string{
	&PCB_TXN_OPS_MAX:               "TXN_OPS_MAX",
	&PCB_RESPONSE_SIZE_MAX:         "RESPONSE_SIZE_MAX",
	&PCB_BATCH_LEASE_RENEWAL_LIMIT: "BATCH_LEASE_RENEWAL_LIMIT",
}
